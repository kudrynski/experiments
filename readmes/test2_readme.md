...
[The model](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.mv6omvargtze)

[Default configuration](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.81gzhjo8xts9)

[Setup](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.mj2lon21q315)

[Requirements](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.gpnn9f38jhat)

[Quick start guide](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.d5y8qlmb8lpr)

[Details](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.fdn4uvtc4wbi)

[Command line options](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.9u356ecwpdsv)

[Getting the data](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.9uf0z8usg5r)

[Training process](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.s97vz5xt4vdj)

[Data preprocessing](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.e5tdvlsegae7)

[Data augmentation](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.7x6xbo4ofqja)

[Enabling mixed precision](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.jr84m1ygm6di)

[Benchmarking](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.evvbli1up9jx)

[Training performance benchmark](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.9hthjo2dvvpk)

[Inference performance benchmark](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.fvwu03klqgqb)

[Results](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.q2z88u6ejpu1)

[Training accuracy results](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.7atmazkbihbj)

[Training performance results](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.r60fcstd6fuj)

[Inference performance results](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.ko5xpht5rzl0)

[Changelog](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.vyik76fhsz7n)

[Known issues](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.78zlpy7nmn1l)
...
The SSD320 v1.2 model is based on the [SSD: Single Shot MultiBox Detector](https://arxiv.org/abs/1512.02325) paper, which describes SSD as “a method for detecting objects in images using a single deep neural network”. The input size is fixed to 320x320.

  

The main difference between this model and the one described in the paper is in the backbone. Specifically, the VGG model is obsolete and is replaced by the ResNet50 model.

  

On top of the ResNet architecture, the [Feature Pyramid Networks](https://arxiv.org/pdf/1612.03144.pdf) are built.

  

Additionally, the original loss function based on hard negative mining is replaced by the [Focal Loss](https://arxiv.org/pdf/1708.02002.pdf) function.

  

Our implementation is based on the existing [model from the TensorFlow models repository](https://github.com/tensorflow/models/blob/master/research/object_detection/samples/configs/ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync.config).

We decreased the input size to 320x320 and we implemented multi-GPU support using Horovod.

  

This model trains with mixed precision tensor cores on Volta, therefore you can get results much faster than training without tensor cores. This model is tested against each NGC monthly container release to ensure consistent accuracy and performance over time.
...
To train your model using mixed precision with tensor cores or using FP32, perform the following steps using the default parameters of the SSD320 v1.2 model on the [COCO 2017](http://cocodataset.org/#download)  dataset.
...
cd [DeepLearningExamples/](https://github.com/NVIDIA/DeepLearningExamples)TensorFlow/Detection/SSD
...
The SSD model training is conducted by the model_main.py script from the object_detection library. Our experiments were done with settings described in the /examples directory. For more details about the available arguments, run:
...
To run training with tensor cores, use ./examples/SSD320_FP16_{1,4,8}GPU.sh scripts. For more information, see the [Enabling mixed precision](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.jr84m1ygm6di) section below.
...
Inference benchmark was run with various batch-sizes on V100 16G GPU. For inference, we are using a single GPU setting. The following examples are taken from the validation dataset.
...
The benchmark script provides extra arguments for extra control over the experiment. We were using the default values for the extra arguments during the experiments. For more details, run:
...
Training time with mixed precision

FP32 mAP

Training time with FP32
...
![](https://lh3.googleusercontent.com/qc0ipLUWI6Q_8KU5YRTWxkxlwZRWiU1Sq4pILb4Yyz6rVv6EqlSm4tdM5NIyB7-LCIMC5c7NXcV65FcyUqVwHt69DGn08e82yyG1jkrZM1rkUHZ8npnrfPQn5-Iga-Ec53QKgjTW)![](https://lh3.googleusercontent.com/0dPTw4raPa9Z4SslpZZKHQ7M8hNN1RGVQx3Jnx0ERC9MdTHbNxp-xNDg4fVLOJV3BfquQR9EfLV1ZXd7YgHZPX8W0IPHjKg50Ch1g6tXYCNN8j3j5X9UHEFvIhYXrVVDTGv-Jd_g)
...
Mixed precision img/s

FP32 img/s

Speed-up with mixed precision

Multi-gpu weak scaling with mixed precision

Multi-gpu weak scaling with FP32
...
To achieve these same results, follow the [Quick Start Guide](https://docs.google.com/document/d/1x5kQn8ZMcaeA7_2GUMtPAvPQgBTVsOEhxIathKmT6-0/edit#heading=h.d5y8qlmb8lpr) outlined above.
...
To achieve these same results, follow the [Quick Start Guide](https://docs.google.com/document/d/13vtfsIdBdFZs-nMvFNut09ddakTQg1b_s0GD7LLNyh4/edit#heading=h.d5y8qlmb8lpr) outlined above.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTEzNjIzOTUwLDIwMTc0NjgyNiwxMzYyOT
A5NjQ4LC0xNjUwMjcwMzUzLDI0MDY0NDI3MiwtMTY0ODAxNDQx
OCwxMDE3NzEyMjkyLDEyNDc0NjMwMTNdfQ==
-->